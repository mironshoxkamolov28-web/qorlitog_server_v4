/**
 * ESP32-4 — Rels zanjiri kuchlanishi (2-guruh: IП, 1СП, 4-6СП)
...
const char* sectionNames[SECTION_COUNT] = { "IП", "1СП", "4-6СП" };
...
float powerCal[SECTION_COUNT] = { 0.753f, 1.0f, 1.0f };
float relayCal[SECTION_COUNT] = { 0.686f, 0.666f, 1.0f };
